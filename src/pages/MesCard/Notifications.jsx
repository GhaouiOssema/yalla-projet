...
const Annonces = () => {
    ...
    if (error) {
        return (
            <div className="w-full p-2  mt-10 border ">
                <Card
                    name="Mes annonces"
                    firstSelectOptions={[
    ...
    return (
        <div className=" w-full min-h-screen  overflow-hidden xl:p-16 lg:p-12 p-2">
            <Card
                name="Mes annonces"
                firstSelectOptions={[
                    { value: "1", label: "Toutes mes annonces" },
                            ...
                            <div className="flex-1 p-4 w-full sm:w-auto">
                                ...
                                <div className="space-y-1 mb-4 mt-4">
                                    <div className="flex items-center text-sm">
                                        <span className="font-semibold w-8 text-gray-500">
                                            DE
                                        </span>
                                        <span>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="flex items-center text-sm">
                                        ...
                                        <span>
                                            Entre le {formatDate(annonce.date)}{" "}
                                            et le 13 nov.
                                        </span>
                                    </div>
                                </div>
