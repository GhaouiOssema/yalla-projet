                ...
                <div className="mx-auto max-w-4xl space-y-3">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Mettez à jour votre photo de profil pour
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Choisissez ce que vous voulez être notifié par
                                e-mail.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            ...
                            <div className="flex items-center mt-5 justify-between">
                                <div>
                                    ...
                                    <CardDescription>
                                        Recevez une notification lorsque
                                        quelqu'un commente vos publications.
                                    </CardDescription>
                                </div>
                                <FormControlLabel
                                    control={
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Partagez votre profil avec d'autres en utilisant
                                ce lien.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="flex items-center gap-2">
                                <div className="">
                                    <Inpute
                                        readOnly
                                        placeholder="https://example.com/profile/johndoe"
                                        type="text"
                                    />
                                </div>
                                <ContentCopyIcon
                                    className="transition duration-200 hover:text-yellow-600 text-yellow-500"
                                    style={{ fontSize: 30 }}
                                />
                            </div>
                        </CardContent>
